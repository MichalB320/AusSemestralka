...
void Citac::nacitaj(ds::amt::ImplicitSequence<UzemnaJednotka*>* paKraje, ds::amt::ImplicitSequence<UzemnaJednotka*>* paOkresy, ds::amt::ImplicitSequence<UzemnaJednotka*>* paObce)
{
	...
	//		kraje_->insertLast().data_ = new Kraj(sortNumber, code, officialTitle, mediumTitle, shortTitle, note);
	...
	//		okresy_->insertLast().data_ = new Okres(sortNumber, code, officialTitle, mediumTitle, shortTitle, note);
	...
	//		obce_->insertLast().data_ = new Obec(&sortNumber, &code, &officialTitle, &mediumTitle, &shortTitle, &note);
